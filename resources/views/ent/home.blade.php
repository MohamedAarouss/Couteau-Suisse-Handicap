                    ...
                    <div class="card mt-2" style="border-color: #D2351F">
                        ...
                        <div class="card-body">
                            <div class="row m-1 child-container" style="border-color: #D2351F;">
                                <div class="text-center red m-2 square move" data-arrange="1" style="color:#FFFFFF">
                                    <a class="link-size" href="{{ $infos[0]->link }}">
                                        {{ $infos[0]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="2" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[1]->link }}">
                                        {{ $infos[1]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="3" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[2]->link }}">
                                        {{ $infos[2]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="4" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[3]->link }}">
                                        {{ $infos[3]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="5" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[4]->link }}" target="_blank">
                                        {{ $infos[4]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="6" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[5]->link }}" target="_blank">
                                        {{ $infos[5]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="7" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[6]->link }}" target="_blank">
                                        {{ $infos[6]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="8" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[7]->link }}" target="_blank">
                                        {{ $infos[7]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="9" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[8]->link }}" target="_blank">
                                        {{ $infos[8]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="10" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[9]->link }}" target="_blank">
                                        {{ $infos[9]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="11" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[10]->link }}" target="_blank">
                                        {{ $infos[10]->title }}
                                    </a>
                                </div>

                                <div class="text-center red m-2 square move" data-arrange="12" style="color: #FFFFFF">
                                    <a class="link-size" href="{{ $infos[11]->link }}" target="_blank">
                                        {{ $infos[11]->title }}
                                    </a>
                                </div>
                            </div>
